return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>svb', builtin.git_branches, { desc = '[S]earch [V]ersion control git [B]ranches' })
      vim.keymap.set('n', '<leader>svf', builtin.git_files, { desc = '[S]earch [V]ersion control git [F]iles' })
