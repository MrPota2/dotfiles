...
set --global fish_color_search_match --background=2e3c64
set --global fish_color_selection --background=2e3c64
...
set --global fish_pager_color_selected_background --background=2e3c64
